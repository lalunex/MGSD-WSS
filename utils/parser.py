...
LastEditTime: 2024-10-18 18:44:33
...
def parse_args():
    ...
    parser.add_argument('--model_name', default='MGSD', type=str, help="model selection"
                                                                      "you can choose one of ['MGSD', 'GRU4Rec', 'NARM', 'Caser', 'BERT4Rec', 'SASRec', 'STAMP']")
    parser.add_argument('--dataset', default='ml-1m', type=str, help="Dataset to use"
    ...
    parser.add_argument('--hard_noise_num', default=5, type=int, help='add hard noise ratio')
    ...
    parser.add_argument('--reweight_loss_gamma', default=10, type=float, help='reweight loss alpha for ave') # 1-5
    parser.add_argument('--reweight_loss_zeta', default=7, type=float, help='reweight loss lambda for gaussian') # 1-10
